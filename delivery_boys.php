...
<div class="row">
    ...
    <div class="w-25">
        <div class="card mt-30 p-15 bg-secondary">
            <form action="delivery_boy_add_action.php" method="post">
                <div class="text-center text-secondary h5">Add DeliveryBoy</div>
                    <div class="form-group mt-15">
                        <input type="text" name="name" id="name" class="form-control p-5 bg-secondary" placeholder="" required>
                        <label for="name" class="form-label p-5">Enter Name</label>
...
<tbody>
    <?php foreach($deliveryboys as $deliveryboy){ ?>
        <tr>
            <td><?php echo $deliveryboy['deliveryboy_id']?></td>
            <td><?php echo $deliveryboy['name']?></td>
            <td><?php echo $deliveryboy['email']?></td>
            <td><?php echo $deliveryboy['phone']?></td>
            <td><?php echo $deliveryboy['state']?></td>
            <td><?php echo $deliveryboy['city']?></td>
            <?php 

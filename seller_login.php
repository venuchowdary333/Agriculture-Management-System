...
<div class="row">
    ...
    <div class="w-30">
        <div class="card mt-100 p-15 bg-secondary">
            <div class="text-center text-secondary h5">Seller Login</div>
            <form action="seller_login_action.php" method="POST">
                ...
                <div class="text-center mt-5">If you don't have account click and register?here 
                    ...
                    </svg></div><a href="seller_register.php" class="btn bg-primary text-white p-5 mt-5 ">Register</a></div>

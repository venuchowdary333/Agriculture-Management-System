...
<div class="row">
    ...
    <div class="w-25">
        <div class="card mt-30 p-15 bg-secondary">
            <form action="farmer_register_action.php" method="post" onsubmit="return validate()">
                <div class="text-center text-secondary h5">Farmer Registration</div>
                    ...
                    <div class="form-group mt-25">
                        <input type="zipcode" name="zipcode" id="zipcode" class="form-control p-5 bg-secondary" placeholder="" required>
